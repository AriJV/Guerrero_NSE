...
map.getView().fit([-11336738.556273, 1818186.548466, -10867454.171366, 2194925.766879], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Niveles Socioeconomicos en Guerrero</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (89 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Elaboración: Arie Jacome Velasco<br />Fuente: SCINCE 2020 con bace en la metodologia del AMAI.';
            }
